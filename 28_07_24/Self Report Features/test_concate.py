...
df_train = pd.read_csv("../Speakers/Train/Joey_train.csv")
df_dev = pd.read_csv("../Speakers/Dev/Joey_dev.csv")
df_test = pd.read_csv("../Speakers/Test/Joey_test.csv")
...
add_scene_number()
df.to_csv('Final Speakers Data/joey_joint.csv',index=False)
