...
train = pd.read_csv('../Self Report Features/Final Speakers Data/joey_train.csv')
test = pd.read_csv('../Self Report Features/Final Speakers Data/joey_test.csv')
...
train.to_csv('../Self Report Features/Final Speakers Data/joey_train.csv', index=False)
test.to_csv('../Self Report Features/Final Speakers Data/joey_test.csv', index=False)